...
local function _1_(...)
  ...
  return {require("aniseed.nvim.util"), require("aniseed.eval"), require("aniseed.core"), require("aniseed.string"), require("aniseed.fennel"), require("aniseed.test"), require("aniseed.nvim")}
end
local _2_ = _1_(...)
local nu = _2_[1]
local eval = _2_[2]
