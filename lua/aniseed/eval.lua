...
do
  local module_0_ = {}
  package.loaded["aniseed.eval"] = module_0_
  _0_0 = module_0_
end
local _local_0_ = {require("aniseed.core"), require("aniseed.compile"), require("aniseed.fennel"), require("aniseed.fs"), require("aniseed.nvim")}
local a = _local_0_[1]
