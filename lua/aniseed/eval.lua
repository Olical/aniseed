...
local _1_
do
  local name_4_auto = "aniseed.eval"
  local module_5_auto
  do
...
local function _6_(...)
  ...
  local function _5_()
    return {autoload("aniseed.core"), autoload("aniseed.compile"), autoload("aniseed.fennel"), autoload("aniseed.fs"), autoload("aniseed.nvim")}
  end
  ok_3f_21_auto, val_22_auto = pcall(_5_)
  if ok_3f_21_auto then
    _1_["aniseed/local-fns"] = {autoload = {a = "aniseed.core", compile = "aniseed.compile", fennel = "aniseed.fennel", fs = "aniseed.fs", nvim = "aniseed.nvim"}}
    return val_22_auto
  else
  ...
  do
    ...
    local function repl0(opts)
      ...
      local function _9_()
        ...
        return fnl.repl(a.merge({compilerEnv = _G, onError = _10_, onValues = _11_, readChunk = coroutine.yield}, opts))
      end
