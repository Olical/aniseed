...
local _1_
do
  local name_4_auto = "aniseed.test"
  local module_5_auto
  do
...
local function _6_(...)
  ...
  local function _5_()
    return {autoload("aniseed.core"), autoload("aniseed.fs"), autoload("aniseed.nvim"), autoload("aniseed.string")}
  end
  ok_3f_21_auto, val_22_auto = pcall(_5_)
  if ok_3f_21_auto then
    _1_["aniseed/local-fns"] = {autoload = {a = "aniseed.core", fs = "aniseed.fs", nvim = "aniseed.nvim", str = "aniseed.string"}}
    return val_22_auto
  else
