...
test: compile
	rm -rf test/lua
	nvim -c "lua print(require('aniseed.view')(require('aniseed.compile').glob('**/*.fnl', 'test/fnl', 'test/lua', {force = true}))) require('aniseed.mapping').init() require('foo')" test/fnl/foo.fnl
